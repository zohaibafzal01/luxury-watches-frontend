...
export default function WhyChooseBid() {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 px-4 bg-[#0A0A0A] text-white">
      <div className="container mx-auto max-w-[920px]">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-sm sm:text-base text-white/90 max-w-2xl mx-auto px-4">
            Experience the future of luxury watch services with our innovative
            platform
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 z-10">
                <h3 className="text-lg sm:text-xl md:text-[24px] font-guyot text-[#CC5500] mb-1">
                  {feature.title}
                </h3>
