  ...
  <section className="py-20 px-4 bg-black text-white">
        <div className="container mx-auto max-w-[800px]">
          <div className="text-center mb-16">
            <h2 className="text-[36px] md:text-4xl font-guyot mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="relative h-[443px] rounded-xl overflow-hidden group shadow-lg"
                style={{
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6 z-10">
                  <h3 className="text-[24px]  font-guyot text-[#f59f0a] mb-1">
                    {feature.title}
                  </h3>
                  <p className="text-[16px] text-white font-stevie">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
