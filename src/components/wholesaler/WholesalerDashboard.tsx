    ...
    const mockInventory: InventoryItem[] = [
      {
        ...
        status: "available",
        description:
          "Black dial, ceramic bezel, excellent condition with box and papers",
    ...
    const mockOrders = [
      {
        ...
        items: [
          { brand: "Rolex", model: "Submariner", quantity: 2, price: 8500 },
        ],
        totalAmount: 17000,
        status: "pending",
      ...
      },
      {
        ...
        items: [
          { brand: "Omega", model: "Speedmaster", quantity: 5, price: 3200 },
        ],
        totalAmount: 16000,
        status: "confirmed",
                ...
                <Card key={item.id} className="luxury-card">
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <CardDescription>
                          Reference: {item.reference} • Year: {item.year} •
                          Stock: {item.stock}
                        </CardDescription>
                      </div>
                  ...
                  <CardContent>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button className="luxury-button">Add to Order</Button>
                    </div>
                  </CardContent>
                </Card>
              ))}
