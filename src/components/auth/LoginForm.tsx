    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted/20 p-4">
      <Card className="w-full max-w-md luxury-card">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Sign in to your ChronoBid account to continue your luxury watch journey
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-6 p-4 bg-muted/50 rounded-lg">
              ...
              <div className="space-y-1 text-xs">
                <p><strong>Admin:</strong> admin@chronobid.com</p>
                <p><strong>Dealer:</strong> dealer@chronobid.com</p>
                <p><strong>Consumer:</strong> consumer@chronobid.com</p>
                <p><strong>Wholesaler:</strong> wholesaler@chronobid.com</p>
                <p className="text-muted-foreground mt-1">Password: any text</p>
              </div>
            </div>
          </form>
        </CardContent>
