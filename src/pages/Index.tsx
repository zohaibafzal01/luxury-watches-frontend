...
const Index: React.FC = () => {
  ...
  return (
    <div className="min-h-screen ">
      <section className="relative min-h-[90vh] sm:h-[90vh] bg-black/70 background-blur-md text-white overflow-hidden pt-16 sm:pt-20">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-0 py-6 sm:py-12 flex flex-col justify-center min-h-[calc(100vh-4rem)] sm:min-h-[calc(90vh-5rem)] max-w-[95%] sm:max-w-[85%] lg:max-w-[70%]">
          <div className="self-center mt-4 sm:mt-8 lg:-mt-32 text-center">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[48px] font-guyot lg:leading-[120%] mb-6 sm:mb-8 lg:mb-2">
              Reliable Service, Perfectly Matched{" "}
      ...
      /> */}
            <p className="text-sm sm:text-base md:text-[18px] leading-[120%] font-light">
              We're building a modern platform to service and protect your
              favorite timepieces — with clear pricing, expert hands, and no
              surprises.
            </p>
          </div>
          <div className="flex flex-col self-center text-center sm:flex-row sm:items-center text-base sm:text-lg md:text-xl text-gray-200 max-w-full sm:max-w-2xl mb-4 sm:px-0 md:px-12">
            <p className="text-sm sm:text-base md:text-[15px] leading-[120%] font-light">
              Join the Waitlist & Get Our Free Guide: “Top 5 Signs Your Watch
              Needs a Service”
            </p>
          </div>
          ...
          <div className="flex flex-wrap self-center gap-3 sm:gap-4 md:gap-6 text-xs sm:text-sm md:text-[14px] text-white/80 mb-8 sm:mb-0">
